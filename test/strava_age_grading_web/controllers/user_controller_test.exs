defmodule StravaAgeGradingWeb.UserControllerTest do
  use StravaAgeGradingWeb.ConnCase

  alias StravaAgeGrading.Users

  @create_attrs %{access_token: "some access_token", "email.string": "some email.string", refresh_token: "some refresh_token"}
